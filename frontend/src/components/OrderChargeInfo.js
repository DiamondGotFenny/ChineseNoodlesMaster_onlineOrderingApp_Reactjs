...
const OrderChargeInfo = (props) => {
  ...
  const vatPercentage = ((vatRate / 1) * 100).toFixed(2);
  const discountPercentage = ((discountRate / 1) * 100).toFixed(2);
  return (
    <ul className='list-group'>
      ...
      <li id='total' className='list-group-item d-flex justify-content-between'>
        <span>Total (USD)</span>
