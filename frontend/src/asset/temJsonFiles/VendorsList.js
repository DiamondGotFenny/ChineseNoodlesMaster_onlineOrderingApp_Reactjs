import kinKeeNoodleShopImg from '../img/vendor_pics/Kin Kee Noodle Shop.jpg';
import laobaisLanzhouBeefNoodleShopImg from "../img/vendor_pics/LaobaisLanzhouBeefNoodleShop.jpg";
import daoXiaoNoodleImg from "../img/vendor_pics/dao_xiao_noodle.jpg";
import riverSnailsRiceNoodleImg from "../img/vendor_pics/River Snails Rice Noodle.jpg";
import chongqingNoodlesImg from "../img/vendor_pics/chongqing_noodles.jpg";
import shanghaiNoodlesImg from "../img/vendor_pics/Shanghai_noodles.jpg";
import wuChoiKeenoodleshopImg from "../img/vendor_pics/Wu Choi Kee_noodle_shop.jpg";
import wangErYaoRouMianImg from "../img/vendor_pics/wanger_yaoroumian.jpg";


export const vendorsList=[
    {
        imgLink:kinKeeNoodleShopImg,
    ...
    {
        imgLink:laobaisLanzhouBeefNoodleShopImg,
    ...
    {
        imgLink:wuChoiKeenoodleshopImg,
